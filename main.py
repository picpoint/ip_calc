...
'''
# full_network_adress_bin = "10101100000000000000000000000000"
full_network_adress_bin = "ABCDEFGHKLMNOPQRSTWXYZ1234567890"

host_min_bin = full_network_adress_bin[:len(full_network_adress_bin) - 1]
host_min_bin += "1"
# print(f"Host min - {host_min_bin}")
